...
if (isset($_GET['del'])) {
    if (mysqli_query($conn, "delete from company_master where Company_id = '" . $_GET['id'] . "'")) {
        echo "<script>alert('Company deleted successfully..!');location.href='manage-company.php';</script>";
    } else {
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($query)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <a data-toggle="modal" data-target="#edit<?php echo $row['Company_id'] ?>"><i class="fa fa-edit"></i></a> | -->
                                            <a href="manage-company.php?id=<?php echo $row['Company_id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>

                                    <div class="modal fade" id="edit<?php echo $row['Company_id'] ?>" tabindex="-1" aria-labelledby="edit" aria-hidden="true">
