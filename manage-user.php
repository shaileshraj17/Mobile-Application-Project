                            ...
                            <tbody>
                                 <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <a data-toggle="modal" data-target="#edit<?php echo $row['user_id'] ?>"><i class="fa fa-edit"></i></a> | -->
                                            <a href="manage-user.php?id=<?php echo $row['user_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
