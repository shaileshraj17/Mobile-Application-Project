...
if(isset($_GET['del']))
    {
        ...
        {
            echo "<script>alert('District deleted successfully..!');location.href='manage-district.php';</script>";
        }
        else
        {
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a data-toggle="modal" data-target="#edit<?php echo $row['District_id'] ?>"><i class="fa fa-edit"></i></a> |
                                            
                                            <a href="manage-district.php?id=<?php echo $row['District_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
